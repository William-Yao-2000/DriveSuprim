...
dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/labs-r34/single_stage-use_ori_input
...
: '
test: use teacher model, because the distillation is still worked.
'