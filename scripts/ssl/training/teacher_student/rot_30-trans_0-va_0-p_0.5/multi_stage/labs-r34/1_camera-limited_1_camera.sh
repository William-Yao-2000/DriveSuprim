...
dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/labs-r34/stage_layers_$stage_layers-topks_$topks-1_camera-limited_1_camera
...
command_string="$NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training_ssl.py \
    ...
    agent.config.lab.limited_1_camera=true \
...
: '
use black image for img extension
'