...
ema_momentum_start=$1

dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/labs/stage_layers_$stage_layers-topks_$topks-use_cosine_ema_scheduler_$ema_momentum_start
...
command_string="python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training_ssl.py \
    ...
    agent.config.lab.ema_momentum_start=$ema_momentum_start \
