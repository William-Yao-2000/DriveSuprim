...
only_ori_input=$1
ban_soft_label_loss=$2


dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/labs/stage_layers_$stage_layers-topks_$topks-1_camera
