...
dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/lab/stage_layers_$stage_layers-topks_$topks-$agent-update_buffer_in_ema
...
command_string="python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training_ssl.py \
    ...
    agent.config.lab.update_buffer_in_ema=true \
