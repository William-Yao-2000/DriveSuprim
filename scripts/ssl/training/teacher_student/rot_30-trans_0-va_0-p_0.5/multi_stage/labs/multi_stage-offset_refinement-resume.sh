...
dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/multi_stage/labs/stage_layers_$stage_layers-topks_$topks-offset_refinement
