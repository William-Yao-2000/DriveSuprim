...
va=0
probability=0.5
dir=training/ssl/teacher_student/rot_$rot-trans_$trans-va_$va-p_$probability/not_rotation-mask
...
command_string="python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training_ssl.py \
    ...
    agent.config.use_rotation_loss=false \
    agent.config.use_mask_loss=true \
