...
: '
usage:
bash scripts/ssl/evaluation/lab/eval_vit-multi_stage-1_camera.sh \
  6 training/ssl/teacher_student/rot_30-trans_0-va_0-p_0.5/multi_stage/labs/stage_layers_3-topks_256-1_camera \
  1 3 256
'