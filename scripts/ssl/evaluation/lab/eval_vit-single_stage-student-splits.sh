...
: '
usage:
bash scripts/ssl/evaluation/lab/eval_vit-single_stage-student-splits.sh \
    8 training/ssl/teacher_student/rot_30-trans_0-va_0-p_0.5/multi_stage/labs/hydra_mdp_pp/hydra_img_vit_ssl \
