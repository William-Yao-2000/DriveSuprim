...
do
    ...
    submit_job \
        ...
        --dependent_clones 0 \
        --partition $partition \
        -c ". /lustre/fsw/portfolios/av/users/shiyil/yaowenh/pre.sh; bash scripts/ssl/training/teacher_student/rot_30-trans_0-va_0-p_0.5/ensemble_3-lr3x-resume.sh $epoch"
