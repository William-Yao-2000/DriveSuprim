...
submit_job \
    ...
    --partition $partition \
    --account av_research \
    -c ". /lustre/fsw/portfolios/av/users/shiyil/yaowenh/pre-navsim_v2.sh; bash scripts/ssl/evaluation/labs-r34/eval_r34-multi_stage-1_camera.sh $epoch $dir"


: '
usage:
bash scripts/slurm_bash/ssl/evaluation/labs-r34/eval_r34-multi_stage-1_camera.sh \
