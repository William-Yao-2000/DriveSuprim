...
submit_job \
    ...
    --partition $partition \
    --account av_research \
    -c ". /lustre/fsw/portfolios/av/users/shiyil/yaowenh/pre-navsim_v2.sh; bash scripts/ssl/evaluation/lab/eval_vit-multi_stage-5_camera.sh $epoch $dir $num_refinement_stage $stage_layers $topks"


: '
usage:
bash scripts/slurm_bash/ssl/evaluation/lab/eval_vit-multi_stage-5_camera.sh \
    3 training/ssl/teacher_student/rot_30-trans_0-va_0-p_0.5/multi_stage/labs/stage_layers_3-topks_256-5_camera \
