...
> Score Generation is time-consuming. You can also ignore the following steps and directly download our [generated score data](https://huggingface.co/alkaid-2000/DriveSuprim/resolve/main/traj_pdm_v2/ori/vocab_score_8192_navtrain_final/navtrain.pkl).
